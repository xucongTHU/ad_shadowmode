...
CAPNP_DECLARE_SCHEMA(ea7cadbe0fdd4e58);
CAPNP_DECLARE_SCHEMA(933a88866b60fe65);
enum class Level_933a88866b60fe65: uint16_t {
  INFO,
  WARNING,
  ERROR,
  FATAL,
};
CAPNP_DECLARE_ENUM(Level, 933a88866b60fe65);
CAPNP_DECLARE_SCHEMA(dd7d255fba16c143);
...
struct DiagInfo {
  ...
  class Builder;
  class Pipeline;
  typedef ::capnp::schemas::Level_933a88866b60fe65 Level;


  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(ea7cadbe0fdd4e58, 2, 2)
    #if !CAPNP_LITE
...
struct DiagMsg {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(dd7d255fba16c143, 0, 3)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
public:
  ...
  inline  ::senseAD::msg::ad_framework_sdk::DiagInfo::Level getLevel() const;
...
public:
  ...
  inline  ::senseAD::msg::ad_framework_sdk::DiagInfo::Level getLevel();
  inline void setLevel( ::senseAD::msg::ad_framework_sdk::DiagInfo::Level value);
...
public:
  ...
  inline  ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>::Reader getInfos() const;
...
public:
  ...
  inline  ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>::Builder getInfos();
  inline void setInfos( ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>::Reader value);
  inline  ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>::Builder initInfos(unsigned int size);
  inline void adoptInfos(::capnp::Orphan< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>>&& value);
  inline ::capnp::Orphan< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>> disownInfos();
...
inline  ::senseAD::msg::ad_framework_sdk::DiagInfo::Level DiagInfo::Reader::getLevel() const {
  return _reader.getDataField< ::senseAD::msg::ad_framework_sdk::DiagInfo::Level>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline  ::senseAD::msg::ad_framework_sdk::DiagInfo::Level DiagInfo::Builder::getLevel() {
  return _builder.getDataField< ::senseAD::msg::ad_framework_sdk::DiagInfo::Level>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void DiagInfo::Builder::setLevel( ::senseAD::msg::ad_framework_sdk::DiagInfo::Level value) {
  _builder.setDataField< ::senseAD::msg::ad_framework_sdk::DiagInfo::Level>(
...
inline  ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>::Reader DiagMsg::Reader::getInfos() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>>::get(_reader.getPointerField(
      ::capnp::bounded<2>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>::Builder DiagMsg::Builder::getInfos() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>>::get(_builder.getPointerField(
      ::capnp::bounded<2>() * ::capnp::POINTERS));
}
inline void DiagMsg::Builder::setInfos( ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>>::set(_builder.getPointerField(
      ::capnp::bounded<2>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>::Builder DiagMsg::Builder::initInfos(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>>::init(_builder.getPointerField(
      ::capnp::bounded<2>() * ::capnp::POINTERS), size);
}
inline void DiagMsg::Builder::adoptInfos(
    ::capnp::Orphan< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>>::adopt(_builder.getPointerField(
      ::capnp::bounded<2>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>> DiagMsg::Builder::disownInfos() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::senseAD::msg::ad_framework_sdk::DiagInfo,  ::capnp::Kind::STRUCT>>::disown(_builder.getPointerField(
      ::capnp::bounded<2>() * ::capnp::POINTERS));
}
