...
#include "ad_base/class_loader/exception.h"

namespace senseAD {
namespace base {
namespace class_loader {

#define CLASS_LOADER_SHARED_OBJECT_INITIALIZER_FN_NAME \
    ClassLoaderSharedObjectInitializer
#define CLASS_LOADER_SHARED_OBJECT_INITIALIZER_FN_NAME_STR \
    "ClassLoaderSharedObjectInitializer"
