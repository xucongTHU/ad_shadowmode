...
#define PRINT_THEAD_ID senseAD::LoggingHelper::GetThreadId()

#define CHECK_SEVERITY(severity) \
    senseAD::LogManager::Instance().ShouldLogging(ADLOG_LEVEL_##severity)
...
#define LOGSTREAM_SEVERITY(severity) \
    LOGSTREAM_SEVERITY_IF(severity, CHECK_SEVERITY(severity))
...
#define SENSEAD_LOG_ACTIVE_LEVEL ADLOG_LEVEL_TRACE
#endif

#if SENSEAD_LOG_ACTIVE_LEVEL <= ADLOG_LEVEL_TRACE
...
#if SENSEAD_LOG_ACTIVE_LEVEL <= ADLOG_LEVEL_DEBUG
...
#if SENSEAD_LOG_ACTIVE_LEVEL <= ADLOG_LEVEL_INFO
...
#if SENSEAD_LOG_ACTIVE_LEVEL <= ADLOG_LEVEL_WARN
...
#if SENSEAD_LOG_ACTIVE_LEVEL <= ADLOG_LEVEL_ERROR
...
#if SENSEAD_LOG_ACTIVE_LEVEL <= ADLOG_LEVEL_CRITICAL
...
#define CHECK_FILE_SEVERITY(severity) \
    senseAD::FileLogManager::Instance().ShouldLogging(ADLOG_LEVEL_##severity)
...
#define SENSEAD_FILE_LOG_ACTIVE_LEVEL ADLOG_LEVEL_TRACE
#endif
