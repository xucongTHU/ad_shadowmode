...
class Manager {
 public:
  ...
  using DDSWriterQos = eprosima::fastdds::dds::DataWriterQos;
  using DDSReaderQos = eprosima::fastdds::dds::DataReaderQos;
   ...
   */
  bool StartDiscovery(DDSParticipant* participant);
 ...
 protected:
  ...
  eprosima::fastdds::dds::Topic* mp_topic_;
  std::mutex lock_;
  eprosima::fastdds::dds::Subscriber* mp_subscriber_;
  eprosima::fastdds::dds::DataReader* mp_reader_;

  DDSParticipant* mp_participant_;
  SubscriberListener* listener_;
  std::unordered_map<std::string, std::string> change_msg_recv_buf_;
