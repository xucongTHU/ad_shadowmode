...
constexpr OptionalMode OptionalMode_MAX = DISABLED;
...
class ShmConf PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kShmTypeFieldNumber = 3,
    kShmLocatorFieldNumber = 4,
    kBlockNum10MMoreFieldNumber = 5,
    kMessageSize10MMoreFieldNumber = 6,
    kNotifierSleepUsFieldNumber = 2,
  };
  ...
  // optional .apollo.cyber.proto.ShmMulticastLocator shm_locator = 4;
  ...
  // optional uint64 block_num_10m_more = 5;
  bool has_block_num_10m_more() const;
  private:
  bool _internal_has_block_num_10m_more() const;
  public:
  void clear_block_num_10m_more();
  ::PROTOBUF_NAMESPACE_ID::uint64 block_num_10m_more() const;
  void set_block_num_10m_more(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_block_num_10m_more() const;
  void _internal_set_block_num_10m_more(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:

  // optional uint64 message_size_10m_more = 6;
  bool has_message_size_10m_more() const;
  private:
  bool _internal_has_message_size_10m_more() const;
  public:
  void clear_message_size_10m_more();
  ::PROTOBUF_NAMESPACE_ID::uint64 message_size_10m_more() const;
  void set_message_size_10m_more(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_message_size_10m_more() const;
  void _internal_set_message_size_10m_more(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:

  // optional uint64 notifier_sleep_us = 2 [default = 1000];
  bool has_notifier_sleep_us() const;
  private:
  bool _internal_has_notifier_sleep_us() const;
  public:
  void clear_notifier_sleep_us();
  ::PROTOBUF_NAMESPACE_ID::uint64 notifier_sleep_us() const;
  void set_notifier_sleep_us(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_notifier_sleep_us() const;
  void _internal_set_notifier_sleep_us(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 block_num_10m_more_;
  ::PROTOBUF_NAMESPACE_ID::uint64 message_size_10m_more_;
  ::PROTOBUF_NAMESPACE_ID::uint64 notifier_sleep_us_;
  friend struct ::TableStruct_cyber_2fproto_2ftransport_5fconf_2eproto;
};
// -------------------------------------------------------------------
...
class ResourceLimit PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kMaxMessageSizeFieldNumber = 2,
    kMaxHistoryDepthFieldNumber = 1,
  };
  // optional uint32 max_message_size = 2;
  bool has_max_message_size() const;
  private:
  bool _internal_has_max_message_size() const;
  public:
  void clear_max_message_size();
  ::PROTOBUF_NAMESPACE_ID::uint32 max_message_size() const;
  void set_max_message_size(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_max_message_size() const;
  void _internal_set_max_message_size(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::uint32 max_message_size_;
...
// optional uint64 notifier_sleep_us = 2 [default = 1000];
inline bool ShmConf::_internal_has_notifier_sleep_us() const {
  bool value = (_has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool ShmConf::has_notifier_sleep_us() const {
  return _internal_has_notifier_sleep_us();
}
inline void ShmConf::clear_notifier_sleep_us() {
  notifier_sleep_us_ = PROTOBUF_ULONGLONG(1000);
  _has_bits_[0] &= ~0x00000020u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ShmConf::_internal_notifier_sleep_us() const {
  return notifier_sleep_us_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ShmConf::notifier_sleep_us() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ShmConf.notifier_sleep_us)
  return _internal_notifier_sleep_us();
}
inline void ShmConf::_internal_set_notifier_sleep_us(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000020u;
  notifier_sleep_us_ = value;
}
inline void ShmConf::set_notifier_sleep_us(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_notifier_sleep_us(value);
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.ShmConf.notifier_sleep_us)
}
...
// optional uint64 block_num_10m_more = 5;
inline bool ShmConf::_internal_has_block_num_10m_more() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool ShmConf::has_block_num_10m_more() const {
  return _internal_has_block_num_10m_more();
}
inline void ShmConf::clear_block_num_10m_more() {
  block_num_10m_more_ = PROTOBUF_ULONGLONG(0);
  _has_bits_[0] &= ~0x00000008u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ShmConf::_internal_block_num_10m_more() const {
  return block_num_10m_more_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ShmConf::block_num_10m_more() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ShmConf.block_num_10m_more)
  return _internal_block_num_10m_more();
}
inline void ShmConf::_internal_set_block_num_10m_more(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000008u;
  block_num_10m_more_ = value;
}
inline void ShmConf::set_block_num_10m_more(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_block_num_10m_more(value);
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.ShmConf.block_num_10m_more)
}

// optional uint64 message_size_10m_more = 6;
inline bool ShmConf::_internal_has_message_size_10m_more() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool ShmConf::has_message_size_10m_more() const {
  return _internal_has_message_size_10m_more();
}
inline void ShmConf::clear_message_size_10m_more() {
  message_size_10m_more_ = PROTOBUF_ULONGLONG(0);
  _has_bits_[0] &= ~0x00000010u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ShmConf::_internal_message_size_10m_more() const {
  return message_size_10m_more_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ShmConf::message_size_10m_more() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ShmConf.message_size_10m_more)
  return _internal_message_size_10m_more();
}
inline void ShmConf::_internal_set_message_size_10m_more(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000010u;
  message_size_10m_more_ = value;
}
inline void ShmConf::set_message_size_10m_more(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_message_size_10m_more(value);
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.ShmConf.message_size_10m_more)
}
...
// optional uint32 max_message_size = 2;
inline bool ResourceLimit::_internal_has_max_message_size() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool ResourceLimit::has_max_message_size() const {
  return _internal_has_max_message_size();
}
inline void ResourceLimit::clear_max_message_size() {
  max_message_size_ = 0u;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 ResourceLimit::_internal_max_message_size() const {
  return max_message_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 ResourceLimit::max_message_size() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ResourceLimit.max_message_size)
  return _internal_max_message_size();
}
inline void ResourceLimit::_internal_set_max_message_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000001u;
  max_message_size_ = value;
}
inline void ResourceLimit::set_max_message_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_max_message_size(value);
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.ResourceLimit.max_message_size)
}
