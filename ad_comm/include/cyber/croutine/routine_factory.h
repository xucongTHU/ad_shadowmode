...
RoutineFactory __attribute__((optimize("O0")))
CreateRoutineFactory(F &&f, const std::shared_ptr<data::DataVisitor<M0>> &dv) {
...
RoutineFactory __attribute__((optimize("O0"))) CreateRoutineFactory(
...
RoutineFactory __attribute__((optimize("O0")))
CreateRoutineFactory(Function &&f) {
  RoutineFactory factory;
