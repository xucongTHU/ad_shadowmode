...
// source: ad_mw/proto/qos_profile.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_ad_5fmw_2fproto_2fqos_5fprofile_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ad_5fmw_2fproto_2fqos_5fprofile_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ad_5fmw_2fproto_2fqos_5fprofile_2eproto
...
struct TableStruct_ad_5fmw_2fproto_2fqos_5fprofile_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ad_5fmw_2fproto_2fqos_5fprofile_2eproto;
namespace senseAD {
namespace mw {
namespace proto {
class QosProfile;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::senseAD::mw::proto::QosProfile* Arena::CreateMaybeMessage<::senseAD::mw::proto::QosProfile>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace senseAD {
namespace mw {
namespace proto {
...
class QosProfile PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:senseAD.mw.proto.QosProfile) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "senseAD.mw.proto.QosProfile";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_ad_5fmw_2fproto_2fqos_5fprofile_2eproto);
    return ::descriptor_table_ad_5fmw_2fproto_2fqos_5fprofile_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // optional .senseAD.mw.proto.QosHistoryPolicy history = 1 [default = HISTORY_KEEP_LAST];
  bool has_history() const;
  private:
  bool _internal_has_history() const;
  public:
  void clear_history();
  ::senseAD::mw::proto::QosHistoryPolicy history() const;
  void set_history(::senseAD::mw::proto::QosHistoryPolicy value);
  private:
  ::senseAD::mw::proto::QosHistoryPolicy _internal_history() const;
  void _internal_set_history(::senseAD::mw::proto::QosHistoryPolicy value);
  public:

  // optional uint32 depth = 2 [default = 20];
  ...
  // optional .senseAD.mw.proto.QosReliabilityPolicy reliability = 4 [default = RELIABILITY_BEST_EFFORT];
  bool has_reliability() const;
  private:
  bool _internal_has_reliability() const;
  public:
  void clear_reliability();
  ::senseAD::mw::proto::QosReliabilityPolicy reliability() const;
  void set_reliability(::senseAD::mw::proto::QosReliabilityPolicy value);
  private:
  ::senseAD::mw::proto::QosReliabilityPolicy _internal_reliability() const;
  void _internal_set_reliability(::senseAD::mw::proto::QosReliabilityPolicy value);
  public:

  // optional .senseAD.mw.proto.QosDurabilityPolicy durability = 5 [default = DURABILITY_VOLATILE];
  bool has_durability() const;
  private:
  bool _internal_has_durability() const;
  public:
  void clear_durability();
  ::senseAD::mw::proto::QosDurabilityPolicy durability() const;
  void set_durability(::senseAD::mw::proto::QosDurabilityPolicy value);
  private:
  ::senseAD::mw::proto::QosDurabilityPolicy _internal_durability() const;
  void _internal_set_durability(::senseAD::mw::proto::QosDurabilityPolicy value);
  public:

  // @@protoc_insertion_point(class_scope:senseAD.mw.proto.QosProfile)
 private:
  class _Internal;
  ...
  int reliability_;
  int durability_;
  friend struct ::TableStruct_ad_5fmw_2fproto_2fqos_5fprofile_2eproto;
};
// ===================================================================
...
inline ::senseAD::mw::proto::QosHistoryPolicy QosProfile::_internal_history() const {
  return static_cast< ::senseAD::mw::proto::QosHistoryPolicy >(history_);
}
inline ::senseAD::mw::proto::QosHistoryPolicy QosProfile::history() const {
  // @@protoc_insertion_point(field_get:senseAD.mw.proto.QosProfile.history)
  return _internal_history();
}
inline void QosProfile::_internal_set_history(::senseAD::mw::proto::QosHistoryPolicy value) {
  assert(::senseAD::mw::proto::QosHistoryPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  history_ = value;
}
inline void QosProfile::set_history(::senseAD::mw::proto::QosHistoryPolicy value) {
  _internal_set_history(value);
  // @@protoc_insertion_point(field_set:senseAD.mw.proto.QosProfile.history)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 QosProfile::depth() const {
  // @@protoc_insertion_point(field_get:senseAD.mw.proto.QosProfile.depth)
...
inline void QosProfile::set_depth(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:senseAD.mw.proto.QosProfile.depth)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 QosProfile::mps() const {
  // @@protoc_insertion_point(field_get:senseAD.mw.proto.QosProfile.mps)
...
inline void QosProfile::set_mps(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:senseAD.mw.proto.QosProfile.mps)
}
...
inline ::senseAD::mw::proto::QosReliabilityPolicy QosProfile::_internal_reliability() const {
  return static_cast< ::senseAD::mw::proto::QosReliabilityPolicy >(reliability_);
}
inline ::senseAD::mw::proto::QosReliabilityPolicy QosProfile::reliability() const {
  // @@protoc_insertion_point(field_get:senseAD.mw.proto.QosProfile.reliability)
  return _internal_reliability();
}
inline void QosProfile::_internal_set_reliability(::senseAD::mw::proto::QosReliabilityPolicy value) {
  assert(::senseAD::mw::proto::QosReliabilityPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000008u;
  reliability_ = value;
}
inline void QosProfile::set_reliability(::senseAD::mw::proto::QosReliabilityPolicy value) {
  _internal_set_reliability(value);
  // @@protoc_insertion_point(field_set:senseAD.mw.proto.QosProfile.reliability)
}
...
inline ::senseAD::mw::proto::QosDurabilityPolicy QosProfile::_internal_durability() const {
  return static_cast< ::senseAD::mw::proto::QosDurabilityPolicy >(durability_);
}
inline ::senseAD::mw::proto::QosDurabilityPolicy QosProfile::durability() const {
  // @@protoc_insertion_point(field_get:senseAD.mw.proto.QosProfile.durability)
  return _internal_durability();
}
inline void QosProfile::_internal_set_durability(::senseAD::mw::proto::QosDurabilityPolicy value) {
  assert(::senseAD::mw::proto::QosDurabilityPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000010u;
  durability_ = value;
}
inline void QosProfile::set_durability(::senseAD::mw::proto::QosDurabilityPolicy value) {
  _internal_set_durability(value);
  // @@protoc_insertion_point(field_set:senseAD.mw.proto.QosProfile.durability)
}
...
template <> struct is_proto_enum< ::senseAD::mw::proto::QosHistoryPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::senseAD::mw::proto::QosHistoryPolicy>() {
  return ::senseAD::mw::proto::QosHistoryPolicy_descriptor();
}
template <> struct is_proto_enum< ::senseAD::mw::proto::QosReliabilityPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::senseAD::mw::proto::QosReliabilityPolicy>() {
  return ::senseAD::mw::proto::QosReliabilityPolicy_descriptor();
}
template <> struct is_proto_enum< ::senseAD::mw::proto::QosDurabilityPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::senseAD::mw::proto::QosDurabilityPolicy>() {
  return ::senseAD::mw::proto::QosDurabilityPolicy_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ad_5fmw_2fproto_2fqos_5fprofile_2eproto
